...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 配置不会被拦截的链接 顺序判断
        filterChainDefinitionMap.put("/interact/fansCtrlNode/agentHeartBeat", "anon"); //ads代理
        filterChainDefinitionMap.put("/interact/fansCtrlAccount/querySyncBrowserNoList", "anon"); //代理检查个人信息更新情况
